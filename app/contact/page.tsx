        ...
        <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-[#222222]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-[#222222] resize-none"
            ...
            <div>
              ...
              {/* Map Placeholder */}
              <div className="mt-8 bg-gray-300 rounded h-64 flex items-center justify-center">
                <p className="text-[#666666]">Map integration with Dubai & Pakistan offices</p>
              </div>
            </div>
          </div>
        </section>
